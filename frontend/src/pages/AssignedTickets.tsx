...
const AssignedTickets = () => {
  ...
  const stats = [
    { label: "Total assigned", value: total, icon: <ConfirmationNumber sx={{ fontSize: 20 }} />, color: "#41431B" },
      ...
      >
        ...
        {tickets.length === 0 ? (
          ...
          >
            ...
            <Typography fontSize={14} color="rgba(65,67,27,0.4)">
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: "rgba(174,183,132,0.08)" }}>
                  {["Title", "Status", "Priority", "Category", "Created by", "Created at", "Actions"].map(
                    (col) => (
                      <TableCell
                        key={col}
                        sx={{
