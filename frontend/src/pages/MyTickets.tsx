  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        {[
          { label: "Total my tickets", value: totalCount, color: C.navy, bg: "rgba(11,22,44,0.06)" },
      ...
      <Box sx={{
        ...
        {loading ? (
          ...
          <Box sx={{ p: 6, textAlign: "center" }}>
            <Typography fontSize={14} color={C.textMuted} fontFamily="Inter, sans-serif" mb={2}>
              No tickets found
            </Typography>
            <Button
              variant="contained"
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: "#F8FAFC" }}>
                  {["Title", "Status", "Priority", "Category", "Assigned To", "Date", "Actions"].map((col) => (
                    <TableCell
                      key={col}
                      sx={{
                        fontWeight: 600,
