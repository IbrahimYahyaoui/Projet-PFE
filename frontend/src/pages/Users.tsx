            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: C.bgPage }}>
                  {["Utilisateur", "Email", "Rôle", "Membre depuis", "Actions"].map(
                    (h) => (
                      <TableCell
                        key={h}
                        sx={{
        ...
        <DialogActions sx={{ p: 2.5, gap: 1 }}>
          <Button
            ...
            sx={{
              ...
              borderRadius: "10px",
              textTransform: "none",
              "&:hover": { backgroundColor: C.bgPage },
            }}
          >
            Annuler
          </Button>
          <Button
            ...
            startIcon={
              formLoading ? (
                <CircularProgress size={16} sx={{ color: C.navy }} />
              ) : undefined
            }
            sx={{
              fontFamily: "Inter, sans-serif",
              ...
              px: 3,
              "&:hover": { backgroundColor: C.accentHover },
              "&.Mui-disabled": { backgroundColor: C.slate, color: C.textMuted },
            }}
          >
